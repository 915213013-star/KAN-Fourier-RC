...
import metrics_2016 as base_metrics
...
def main():
    ...
    # Held-out labels are not inspected while candidate actions or thresholds
    # are selected. They are consumed only by the locked final report below.
    base_test_m = None
    print("[*] Held-out diagnostics are deferred until the final configuration is locked.")
