...
def checkpoint_paths_10b(args, fold):
    ...
    suffix = (
        f"fourier_compressed_oof_10b_{oofp.PROTOCOL_TAG}_{args.variant}{tag_part}_"
...
def main():
    ...
    if not args.output_cache:
        args.output_cache = common10b.relpath(
            "results",
            (
                f"fourier_compressed_oof_10b_{oofp.PROTOCOL_TAG}_{args.variant}_mseed{args.model_seed}_"
    ...
    return impl.main_with_args(args, title="Train RML2016.10B compact KAN-Fourier OOF cache")
