...
CACHES = {
    "KAN-Fourier": RESULTS
    / "fourier_compressed_10b_full_geo_2expert_mseed361_split1_valtest_probs_for_soup.npz",
    "IQCC-Former": RESULTS
    / "cv_trn_aux_v2_oof_10b_mseed141_f3e220_split1_trainvaltest_probs_for_meta.npz",
    "KAN-Fourier-RC": RESULTS
    / "fourier_compressed_10b_fullgeo2expert_mseed361_hcs_pairwise_extraaux_meta_split1_predictions.npz",
}

CURVE_PNG = FIGURES / "fig_10b_snr.png"
CURVE_CSV = FIGURES / "fig_10b_snr.csv"
CM_PATHS = {
    -6: FIGURES / "fig_10b_cm_m6.png",
    0: FIGURES / "fig_10b_cm_0.png",
}
...
def main() -> None:
    ...
    print(f"Alignment check passed for {len(caches)} RML2016.10b caches.")
    for name, cache in caches.items():
